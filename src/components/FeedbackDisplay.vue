            ...
            <div class="flex justify-center mb-8">
              <div class="relative w-56 h-56">
                <div class="absolute inset-0 rounded-full"
                     :class="getScoreColor(overallScore).bg + ' opacity-10'"></div>
                ...
                <div class="absolute inset-1 rounded-full bg-white shadow-inner">
                  <svg class="w-full h-full" viewBox="0 0 200 200">
                    ...
                    <g v-for="i in 8" :key="i" :transform="`rotate(${(i-1) * 45} 100 100)`"
                       v-if="overallScore !== null && overallScore !== undefined">
                      <circle
                          cx="100"
                          cy="10"
                ...
                <div class="absolute inset-0 flex flex-col items-center justify-center">
                  <div class="relative">
                    <div class="text-6xl font-black" :class="getScoreColor(overallScore).text"
                ...
                <div v-if="overallScore >= 7" class="absolute inset-0 rounded-full animate-ping opacity-20"
                     :class="getScoreColor(overallScore).bg"></div>
              </div>
            </div>
      ...
      >
        <div :class="`${slide.color.bg} ${slide.color.border} border-2 rounded-2xl p-6 mb-6`">
          <div class="flex items-center justify-between">
            ...
            <div class="px-3 py-1 rounded-full text-sm font-medium" :class="slide.color.badge">
