    ...
    <div class="w-full max-w-md">
      ...
      <div class="bg-white rounded-3xl shadow-lg p-8 border border-slate-100">
        <div v-if="resetSuccess" class="text-center">
          ...
          <h2 class="text-2xl font-bold text-slate-900 mb-3" style="font-family: 'Sora', sans-serif;">Password Reset!</h2>
        ...
        <div v-else>
          <div class="text-center mb-8">
            <h2 class="text-2xl font-bold text-slate-900 mb-3" style="font-family: 'Sora', sans-serif;">Set New Password</h2>
