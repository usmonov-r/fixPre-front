...
<template>
  <div class="min-h-screen relative overflow-hidden bg-slate-50">
    ...
    <div v-if="!isLoggedIn && showRegistrationPrompt"
      ...
      <div class="bg-white rounded-2xl p-8 max-w-md w-full shadow-2xl transform transition-all duration-300 scale-100">
        <div class="text-center">
          ...
          <div class="flex gap-3">
            <button @click="showRegistrationPrompt = false"
                    class="flex-1 px-4 py-2 border border-slate-300 text-slate-700 rounded-lg hover:bg-slate-50 transition-colors duration-200 font-medium"
                    style="font-family: 'Inter', sans-serif;">
              Maybe Later
            </button>
            <button @click="goToRegister"
                    class="flex-1 px-4 py-2 bg-gradient-to-r from-emerald-500 to-blue-600 text-white rounded-lg hover:from-emerald-600 hover:to-blue-700 transition-all duration-200 font-medium shadow-md hover:shadow-lg"
                    style="font-family: 'Inter', sans-serif;">
              Sign Up Free
            </button>
          </div>
    ...
    <div class="relative z-10 w-full max-w-6xl mx-auto px-6 py-8">
      ...
      <div v-if="!isLoading && !feedback" class="max-w-4xl mx-auto mb-10">
            ...
            <label for="file-upload" class="block">
              <div
                ...
                <div class="relative z-10">
                  ...
                  <p class="text-sm text-slate-500" style="font-family: 'Inter', sans-serif;">.pptx, .ppt • Max 20MB</p>
                </div>
              </div>
              <input
                  id="file-upload"
        ...
        <div class="text-center mb-6 mt-8">
          ...
          <h2 class="text-3xl font-bold text-slate-900 mb-3" style="font-family: 'Sora', sans-serif;">Upload → Analyze →
            Improve</h2>
          <p class="text-lg text-slate-600" style="font-family: 'Inter', sans-serif;">Get instant AI-powered feedback on
            your slides</p>
        </div>
      </div>
      <div v-if="isLoading" class="py-16 text-center space-y-6">
        <div class="flex justify-center">
          <div class="relative w-16 h-16">
            <svg class="animate-spin w-full h-full text-slate-300" xmlns="http://www.w3.org/2000/svg" fill="none"
                 viewBox="0 0 24 24">
              <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="2"></circle>
            </svg>
            <svg class="absolute inset-0 animate-spin w-full h-full text-slate-600"
                 style="animation-direction: reverse; animation-duration: 2s;" xmlns="http://www.w3.org/2000/svg"
        ...
        <div>
          <h3 class="text-xl font-semibold text-slate-900 mb-2" style="font-family: 'Sora', sans-serif;">Analyzing your
            presentation</h3>
          ...
          <div class="flex flex-wrap items-center justify-center gap-8 text-sm">
            <div class="flex items-center gap-2">
              <div class="flex -space-x-2">
                <img src="/profile-pics/female-student.png" alt="Student"
                     class="w-6 h-6 rounded-full border-2 border-white object-cover">
                <img src="/profile-pics/male-student.png" alt="Student"
                     class="w-6 h-6 rounded-full border-2 border-white object-cover">
                <img src="/profile-pics/female-student2.png" alt="Student"
                     class="w-6 h-6 rounded-full border-2 border-white object-cover">
                <img src="/profile-pics/male-student-2.png" alt="Student"
                     class="w-6 h-6 rounded-full border-2 border-white object-cover">
              </div>
      ...
      <div v-if="!isLoading && !feedback && !error" class="mb-10 animate-fade-in">
        <div class="text-center mb-6">
          <h3 class="text-3xl font-bold text-slate-900 mb-2" style="font-family: 'Sora', sans-serif;">Why Choose FixPre?
            🚀</h3>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 lg:gap-8 relative">
            ...
            <div class="text-center">
              ...
              <h4 class="text-lg font-bold text-slate-900 mb-2" style="font-family: 'Sora', sans-serif;">Upload Your
                Slides</h4>
              <p class="text-slate-600" style="font-family: 'Inter', sans-serif;">Drag and drop your PowerPoint file</p>
            </div>
      ...
      <div v-if="!isLoading && !feedback && !error" class="mb-10 animate-fade-in">
        <div class="text-center mb-6">
          <h3 class="text-3xl font-bold text-slate-900 mb-2" style="font-family: 'Sora', sans-serif;">What People Say
            💬</h3>
          <p class="text-slate-600" style="font-family: 'Inter', sans-serif;">Join thousands of satisfied presenters</p>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-5">
          <div class="bg-white/70 backdrop-blur-sm rounded-2xl p-5 border border-white/30">
            ...
            <p class="text-slate-700 mb-3 italic" style="font-family: 'Inter', sans-serif;">"FixPre helped me transform
              my pitch deck from good to exceptional. The AI feedback was spot-on and actionable!"</p>
            <div class="flex items-center gap-3">
              <img src="/profile-pics/female-student.png" alt="Sarah Chen"
          ...
          <div class="bg-white/70 backdrop-blur-sm rounded-2xl p-5 border border-white/30">
            ...
            <p class="text-slate-700 mb-3 italic" style="font-family: 'Inter', sans-serif;">"As a student, this tool has
              been a game-changer for my presentations. My grades have improved significantly!"</p>
            <div class="flex items-center gap-3">
              <img src="/profile-pics/male-student.png" alt="Michael Rodriguez"
                   class="w-10 h-10 rounded-full object-cover border-2 border-white shadow-sm">
              <div>
                <p class="font-semibold text-slate-900" style="font-family: 'Inter', sans-serif;">Michael Rodriguez</p>
      ...
      <FeedbackExample :isLoading="isLoading" :feedback="feedback" :error="error"/>
      <div v-if="!isLoading && !feedback && !error" class="mb-16 md:mb-20 scroll-fade-in">
        <div class="relative overflow-hidden bg-gradient-to-br from-slate-800 via-slate-900 to-slate-800 rounded-2xl md:rounded-3xl p-8 md:p-12 lg:p-16 text-center text-white">
          <div class="relative">
            <p class="inline-block text-sm md:text-base font-medium bg-gradient-to-r from-emerald-400 to-cyan-400 text-transparent bg-clip-text mb-4 px-4 py-1.5 rounded-full border border-emerald-500/20 bg-slate-800/80" style="font-family: 'Inter', sans-serif;">
              <span>✨</span> Elevate Your Presentation <span>✨</span>
            </p>

              <h2 class="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6 md:mb-8" style="font-family: 'Sora', sans-serif;">
                <span class="relative inline-block">
                  <span class="relative z-10">
                    <span class="text-transparent bg-clip-text bg-gradient-to-r from-emerald-300 via-cyan-300 to-blue-300">Fix</span> Your
                    <span class="text-transparent bg-clip-text bg-gradient-to-r from-purple-300 via-pink-300 to-rose-300">Pre</span>sentation
                  </span>
                  <span class="absolute -bottom-1 left-0 w-full h-2 bg-gradient-to-r from-emerald-500/30 to-purple-500/30 rounded-full transform -rotate-1 scale-x-110"></span>
                </span>
              ...
              <p class="max-w-2xl mx-auto text-slate-300 text-lg md:text-xl mb-8 md:mb-10 leading-relaxed" style="font-family: 'Inter', sans-serif;">
      ...
      <div class="mt-20 pt-12 border-t border-slate-200">
        <div class="text-center space-y-6">
          ...
          <div class="flex justify-center items-center gap-6">
            <a href="#"
               class="w-8 h-8 rounded-full bg-slate-100 flex items-center justify-center text-slate-500 hover:text-slate-700 hover:bg-slate-200 transition-all duration-300">
...
@keyframes shimmer { 0%, 100% { opacity: 1; } 50% { opacity: 0.7; transform: scale(1.05); } }
